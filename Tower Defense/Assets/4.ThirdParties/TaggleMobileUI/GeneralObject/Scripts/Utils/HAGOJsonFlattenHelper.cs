...
public class HAGOJSONFlattener
{
    ...
    public static JObject Unflatten(IDictionary<string, JToken> keyValues)
    {
    ...
    private static JContainer UnflatenSingle(KeyValuePair<string, JToken> keyValue)
    {
        string path = keyValue.Key;
        JToken value = keyValue.Value;
