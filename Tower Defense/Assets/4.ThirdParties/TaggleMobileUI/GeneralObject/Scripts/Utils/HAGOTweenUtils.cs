...
public class HAGOTweenUtils : MonoBehaviour
{
    ...
    public static void ScrollVerticalTo(ScrollRect scrollRect, RectTransform contentPanel, RectTransform target, Action callback = null, float duration = 0.3f, float offsetY = 48f)
    {
    ...
    public static void ScrollToTop(ScrollRect scrollRect, Action action = null)
    {
        Canvas.ForceUpdateCanvases();
        scrollRect.content.DOAnchorPosY(0f, 0.1f).OnComplete(() => action?.Invoke());
    }

    public static void ScrollToBottom(ScrollRect scrollRect, Action action = null)
    {
        Canvas.ForceUpdateCanvases();
        scrollRect.content.DOAnchorPosY(1f, 0.1f).OnComplete(() => action?.Invoke());
    }
}