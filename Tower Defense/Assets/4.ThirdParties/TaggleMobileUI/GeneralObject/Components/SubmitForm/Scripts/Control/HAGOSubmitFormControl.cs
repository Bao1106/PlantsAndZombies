...
public class HAGOSubmitFormControl
{
	...
	public Action<HAGOUIJsonFormDataDTO> ResultCallbackEvent { get; set; }
	//
	...
	public void CompleteSubmitForm(HAGOUIJsonFormDataDTO data)
    {
    ...
    {
        ExitEvent?.Invoke(() => {
            HAGOSubmitJsonFormManager.Api?.Destroy();
        });
    }
}