...
public class HAGOUIAttachmentItemDTO
{
	...
	public HAGOUIAttachmentItemDTO(string id, HAGOUIAttachmentType type, object resource)
	{
		ID = id;
		TypeInt = (int)type;
		Resource = resource;
	...
	public HAGOUIAttachmentItemDTO(string id, HAGOUIAttachmentType type, string url)
	{
		ID = id;
		TypeInt = (int)type;
		Resource = null;
	...
	public HAGOUIAttachmentItemDTO(long id, HAGOUIAttachmentType type, object resource) : this(id.ToString(), type, resource){}
